...
public class PerformanceThrottler {
    ...
    public void update(int currentFps, PerformanceMonitor.FrameMetrics metrics) {
        ...
        adjustThrottleLevel(avgFps, metrics);
    }
    ...
    private void adjustThrottleLevel(int avgFps, PerformanceMonitor.FrameMetrics metrics) {
        ...
        if (newLevel != throttleLevel) {
            ...
            lodBias = newLodBias;
            entityUpdateInterval = newUpdateInterval;
            particleDensity = newParticleDensity;
