...
public class PerformanceThrottler {
    ...
    public void initialize() {
        ...
        // 根据性能预设调整配置
        CriticalPhotonConfig.PerformancePreset preset = CriticalPhotonConfig.CLIENT.performancePreset.get();
        LOGGER.info("当前性能预设：{} - {}", preset.name(), preset.description);
