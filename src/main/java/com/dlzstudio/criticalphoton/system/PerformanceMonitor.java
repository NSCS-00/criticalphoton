...
public class PerformanceMonitor {
    ...
    public void update() {
        ...
        long frameTime = currentTime - lastFpsUpdate;
    ...
    public void recordPhaseTime(Phase phase, long timeNanos) {
        frameMetrics.setPhaseTime(phase, timeNanos);
    }
    ...
    public static class FrameMetrics {
        ...
        public double getTotalRenderTimeMs() {
            long total = 0;
            for (long time : phaseTimes) total += time;
